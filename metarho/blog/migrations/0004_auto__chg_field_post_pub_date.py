...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('blog_post', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2011, 6, 6)))


    def backwards(self, orm):
        
        # Changing field 'Post.pub_date'
        db.alter_column('blog_post', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
