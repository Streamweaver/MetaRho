...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Post.slug'
        db.alter_column('blog_post', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=75, null=True))
    ...
    models = {
        ...
        'blog.post': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 6, 11, 15, 23, 68726)', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'db_index': 'True', 'max_length': '75', 'blank': 'True'}),
